...
int main()
{
    ...
    std::cout << "Time taken for inserting of " << n << " elems in decart BST: " << diference.count() << " seconds" << std::endl;
    ...
    std::cout << "Time taken for checking of " << n << " elems in decart BST: " << diference1.count() << " seconds" << std::endl;
    ...
    std::cout << "Time taken for removing of " << n << " elems in decart BST: " << diference2.count() << " seconds" << std::endl;
