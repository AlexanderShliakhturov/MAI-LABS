...
ComplexNumber::ComplexNumber(double _real, double _imagine) {
    real = _real;
    imagine = _imagine;
    string_number = -1;
}
...
ComplexNumber ComplexNumber::operator*(ComplexNumber a) {
    ComplexNumber tmp(*this);
    double new_real = tmp.real * a.real - tmp.imagine * a.imagine;
...
ComplexNumber ComplexNumber::operator*=(ComplexNumber a) {
    double new_real = this->real * a.real - this->imagine * a.imagine;
...
ComplexNumber ComplexNumber::operator/(ComplexNumber a) {
    ComplexNumber tmp(*this);
    double new_real = (tmp.real * a.real + tmp.imagine * a.imagine) / (a.real * a.real + a.imagine * a.imagine);
...
ComplexNumber ComplexNumber::operator/=(ComplexNumber a) {
    double new_real = (this->real * a.real + this->imagine * a.imagine) / (a.real * a.real + a.imagine * a.imagine);
